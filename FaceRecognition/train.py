...
from utils.dataset import MXFaceDataset, DataLoaderX, FaceDatasetFolder, AugmentationFaceDatasetFolder
...
def main(args):
    ...
    if cfg.use_augmentation:
        logging.info("Using augmentations with AugmentationFaceDatasetFolder.")
        trainset = AugmentationFaceDatasetFolder(
    ...
    if rank == 0:
        ...
        logging.info(f"Training dataset: {cfg.root_dir}")
        logging.info(f"Output folder: {cfg.output}")
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        callback_verification(global_step, backbone, force=True)
